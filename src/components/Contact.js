...
class Contact extends Component{
    ...
    //It will invoked whenever any change occur in form
    ...
    handleSubmit(event){
        ...
        // To prevent default behavior of form which is redirect
                    ...
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={{size: 3, offset: 1}}>
                                <Input type="select" value={this.state.contactType} name="contactType" onChange={this.handleInputChange}>
                                    <option>Tel.</option>
                                    <option>Email</option>
                                </Input>
                            </Col>
